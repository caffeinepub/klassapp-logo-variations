...
function ColorSwatch({
  color,
  index,
}: { color: (typeof BRAND_COLORS)[0]; index: number }) {
      ...
      <header className="sticky top-0 z-20 bg-card/90 backdrop-blur-md border-b border-border">
        <div className="max-w-6xl mx-auto px-6 py-3.5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link
              to="/"
              data-ocid="brandkit.back.button"
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <span className="font-extrabold font-display text-base tracking-tight">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              data-ocid="brandkit.download_all.button"
              onClick={downloadAll}
      ...
      <main className="max-w-6xl mx-auto px-6 py-16 space-y-24">
        ...
        <section data-ocid="logo.section">
          ...
          <div className="flex justify-end mb-6">
            <button
              type="button"
              data-ocid="brandkit.logo.primary_button"
              onClick={() =>
                downloadFile(
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            >
              ...
              <div className="bg-card px-5 py-4 flex items-center justify-between gap-3">
                ...
                <button
                  type="button"
                  data-ocid="brandkit.logo.icon.button"
                  onClick={() =>
                    downloadFile(
            ...
            >
              ...
              <div className="bg-card px-5 py-4 flex items-center justify-between gap-3">
                ...
                <button
                  type="button"
                  data-ocid="brandkit.logo.stacked.button"
                  onClick={() =>
                    downloadFile(
        ...
        <section data-ocid="logo-dark.section">
          ...
          <div className="flex justify-end">
            <button
              type="button"
              data-ocid="brandkit.logo.dark.button"
              onClick={() =>
                downloadFile(
        ...
        <section data-ocid="business-card.section">
          <SectionHeader
            label="05 — Print"
            title="Business Card"
            description="Standard horizontal business card template. Print at 300 DPI for crisp results."
          />
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="bg-card px-5 py-4 flex items-center justify-between gap-3">
              ...
              <button
                type="button"
                data-ocid="brandkit.business-card.button"
                onClick={() =>
                  downloadFile(
        ...
        <section data-ocid="pitch-deck.section">
          <SectionHeader
            ...
            description="16:9 widescreen title slide for investor presentations, demos, and school briefings."
          />
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="bg-card px-5 py-4 flex items-center justify-between gap-3">
              ...
              <button
                type="button"
                data-ocid="brandkit.pitch-deck.button"
                onClick={() =>
                  downloadFile(
